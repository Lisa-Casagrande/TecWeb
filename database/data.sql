...
-- ==================================================
-- questa riga non serve con docker perchè fa già da solo
-- USE db_InfuseMe;

-- ADMIN
-- Admin di default (per la prof)
-- Email e Password: "admin"
-- i valori che mancano sono NULL o di DEFAULT (non essenziali)
INSERT INTO admin (nome, cognome, email, password_hash) VALUES
('admin', 'admin', 'admin@infuseme.com', 'admin');


-- UTENTE
-- User di default (per la prof)
-- Email e Password: "user"
...
--id_base generato in automatico in ordine crescente
...
-- ================================================================
-- 5. RELAZIONI PRODOTTO-INGREDIENTE (esempi)
-- ================================================================
-- Tè Verde Speziato (id=2)
INSERT INTO prodotto_ingrediente (id_prodotto, id_ingrediente) VALUES
(2, 12), -- Zenzero
(2, 13), -- Cannella
(2, 15); -- Cardamomo

-- Tè Nero ai Frutti Rossi (id=4)
INSERT INTO prodotto_ingrediente (id_prodotto, id_ingrediente) VALUES
(4, 4),  -- Ribes
(4, 8);  -- Lampone

-- Tè Nero all'Arancia e Cannella (id=5)
INSERT INTO prodotto_ingrediente (id_prodotto, id_ingrediente) VALUES
(5, 1),  -- Arancia
(5, 13); -- Cannella

-- Tè Bianco alla Rosa (id=9)
INSERT INTO prodotto_ingrediente (id_prodotto, id_ingrediente) VALUES
(9, 19); -- Petali di Rosa
...
INSERT INTO dettaglio_ordine (id_ordine, prodotto_id, quantita, prezzo_unit) VALUES
(1, 1, 2, 6.50),  -- 2x Tè Verde al Matcha
(1, 4, 1, 6.50);  -- 1x Tè Nero ai Frutti Rossi

-- Ordine 2: Laura Bianchi (con omaggio)
INSERT INTO ordine (id_utente, indirizzo_spedizione, stato_ord, conferma_pagamento, sottototale, spese_spedizione, totale, omaggio, descrizione_omaggio) VALUES
(2, 'Via Verdi 45, Torino, 10100', 'spedito', TRUE, 52.00, 0.00, 52.00, TRUE, 'Camomilla 50g in omaggio');

INSERT INTO dettaglio_ordine (id_ordine, prodotto_id, quantita, prezzo_unit) VALUES
(2, 7, 2, 7.00),  -- 2x Tè Bianco al Limone e Lime
(2, 10, 3, 6.00), -- 3x Tisana Lampone e Vaniglia
(2, 16, 3, 7.00); -- 3x Infuso Alpino


-- ================================================================
-- 7. TRACCIAMENTO ADMIN
-- ================================================================

-- Admin ha aggiunto tutti i prodotti
INSERT INTO add_prodotto (id_admin, id_prodotto) 
SELECT 1, id_prodotto FROM prodotto;

-- Admin ha aggiunto tutte le basi
INSERT INTO add_base (id_admin, id_base) 
SELECT 1, id_base FROM base;

-- Admin ha aggiunto tutti gli ingredienti
