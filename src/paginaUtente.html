...
<body>
    ...
    <section id="area-account" style="display: none;">
        ...
        <section id="profilo-utente">
            ...
            <div class="user-info">
                ...
                <div class="user-details">
                    <p><strong>Nome:</strong> <span id="user-nome">Maria Rossi</span></p>
                    <p><strong>Email:</strong> <span id="user-email">maria.rossi@example.com</span></p>
                    <p><strong><span lang="en">Username</span>:</strong> <span id="user-username">maria_tea</span></p>
                    <p><strong>Data registrazione:</strong> <time datetime="2023-05-15">15 maggio 2023</time></p>
                    <p><a href="modifica-profilo.html">Modifica profilo</a></p>
                </div>
            </div>
        </section>
        
        <!-- Resto del contenuto dell'account... -->
        <section id="ordini-recenti">
            <h2>I Miei Ordini Recenti</h2>
            
            <article class="ordine">
                <h3>Ordine #TEA-2024-0012</h3>
                <p><strong>Data:</strong> <time datetime="2024-01-15">15 gennaio 2024</time></p>
                ...
                <p><a href="dettaglio-ordine.html">Visualizza dettagli ordine</a></p>
            </article>
...
<script>
    // Gestione del sistema di login/registrazione
    document.addEventListener('DOMContentLoaded', function() {
        const loginSection = document.getElementById('login-section');
        const registrazioneSection = document.getElementById('registrazione-section');
        const areaAccount = document.getElementById('area-account');
        const linkRegistrati = document.querySelector('a[href="registrazione.html"]');
        const tornaLogin = document.getElementById('torna-login');
        ...
        if (linkRegistrati) {
            linkRegistrati.addEventListener('click', function(e) {
                e.preventDefault();
                mostraRegistrazione();
            });
        }
        
        // Gestione click su "Torna al Login"
        if (tornaLogin) {
        ...
        if (loginForm) {
            loginForm.addEventListener('submit', function(e) {
                e.preventDefault();
                // Qui andrebbe la logica di autenticazione con il server
        ...
        if (registrazioneForm) {
            registrazioneForm.addEventListener('submit', function(e) {
                e.preventDefault();
                // Qui andrebbe la logica di registrazione con il server
                localStorage.setItem('isLoggedIn', 'true');
                mostraAreaAccount();
            });
        }
