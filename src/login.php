...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($valoreEmail)) $erroreEmail = "Inserisci l'email.";
    if (empty($password)) $errorePassword = "Inserisci la password.";
...
<head>
    ...
    <meta name="description" content="Accedi al tuo account InfuseMe per gestire ordini, preferenze e scoprire le nostre tisane e tè biologici." />
    <meta name="keywords" content="login InfuseMe, accesso account, tè biologico, tisane, gestione account, area personale" />
...
<body>
    ...
    <main id="main-content">
        <section id="login-section">
            <div class="login-container">
                <h1>Accedi al tuo <span lang="en">account</span></h1>
                ...
                <form id="login-form" action="" method="post" novalidate>
                    <fieldset class="form-data">
                        <legend class="sr-only">
                            Inserisci le credenziali per il <span lang="en">login</span>
                        </legend>
   ...
   <button class="back-to-top" id="backToTop" aria-label="Torna all'inizio della pagina">
    ...
    <script src="javaScript/loginValidator.js"></script>
